// src/app/tax-refund/components/FormFiles/TaxDetailsFile.tsx
'use client';
...
export default function TaxDetailsFile({ form, onChange, onNext }: TaxDetailsProps) {
    ...
    const taxYears = [
        '2025 (last year)',
        ...Array.from({ length: 10 }, (_, i) => (2024 - i).toString()),
    ];
    ...
    return (
        <div className="bg-white p-6 rounded-2xl shadow border border-gray-200 space-y-6">
            <h2 className="text-2xl font-bold text-center text-gray-800">Tax Details</h2>
            <p className="text-center text-gray-600">
                Enter your Work and Travel details: program year, state, and DS-2019 entry/exit dates.
            </p>
